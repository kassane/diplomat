...
pub fn gen_type<W: fmt::Write>(
    ...
    match typ {
        ...
        ast::TypeName::Primitive(prim) => {
            write!(out, "{}", d_type_for_prim(prim))?;
        }
...
pub fn name_for_type(typ: &ast::TypeName) -> ast::Ident {
    match typ {
        ...
        ast::TypeName::Primitive(prim) => ast::Ident::from(d_type_for_prim(prim)),
        ...
        ast::TypeName::PrimitiveSlice(_lt, ast::Mutability::Mutable, prim) => {
            ast::Ident::from(format!("ref_mut_prim_slice_{}", d_type_for_prim(prim)))
        }
        ast::TypeName::PrimitiveSlice(_lt, ast::Mutability::Immutable, prim) => {
            ast::Ident::from(format!("ref_prim_slice_{}", d_type_for_prim(prim)))
        }
...
pub fn d_type_for_prim(prim: &PrimitiveType) -> &'static str {
    match prim {
